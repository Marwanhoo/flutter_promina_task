...
class HomeScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      body: SafeArea(
        child: BlocConsumer<ProminaCubit, ProminaStates>(
          ...
          builder: (context, state) {
            if(state is GalleryLoadingState){
              ...
              return _buildGallery(context, state.images);
                          ...
                          child: GlassmorphicContainer(
                            ...
                            child: Column(
                              ...
                              children: [
                                ElevatedButton.icon(
                                  onPressed: () {
                                    BlocProvider.of<ProminaCubit>(context).pickImage(ImageSource.gallery);
                                  },
                                  icon: Image.asset(
                                ...
                                ElevatedButton.icon(
                                  onPressed: () {
                                    BlocProvider.of<ProminaCubit>(context).pickImage(ImageSource.camera);
                                  },
                                  icon: Image.asset(
